      ...
      <div className="max-w-md w-full bg-surface rounded-lg shadow-lg p-8 text-center">
        {status === 'loading' && (
          <>
            ...
            <h2 className="text-2xl font-bold text-ink mb-2">Vérification en cours...</h2>
        ...
        {status === 'success' && (
          <>
            ...
            <h2 className="text-2xl font-bold text-ink mb-2">Email vérifié !</h2>
        ...
        {status === 'error' && (
          <>
            ...
            <h2 className="text-2xl font-bold text-ink mb-2">Erreur de vérification</h2>
            <p className="text-ink-soft mb-6">{message}</p>
            <Link
              to="/login"
              className="inline-flex items-center gap-2 bg-accent text-white px-6 py-3 rounded-lg font-semibold hover:bg-accent-strong transition-colors"

    ...
    <div className="min-h-screen bg-gradient-to-b from-accent via-white to-accent">
      <div className="max-w-5xl mx-auto px-4 py-12">
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl sm:text-4xl font-extrabold text-ink mb-3">Calculateur de droits de douane</h1>
          ...
          <div className="bg-surface rounded-2xl shadow-sm border border-line p-6 space-y-5">
            ...
            <div className="relative">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-3 py-2.5 border border-line rounded-lg text-sm bg-bg"
                />
              ...
              {hsDropdownOpen && debouncedSearch.length >= 2 && (
                <div className="absolute z-30 mt-1 w-full max-h-64 overflow-y-auto rounded-lg border border-line bg-surface shadow-lg">
              ...
              {hsDropdownOpen && debouncedSearch.length < 2 && (
                <div className="absolute z-30 mt-1 w-full rounded-lg border border-line bg-surface shadow-lg p-3">
              ...
              <input
                ...
                className="w-full mt-2 px-3 py-2 border border-line rounded-lg text-sm bg-bg"
              />
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <select value={origin} onChange={e => setOrigin(e.target.value)} className="w-full px-3 py-2 border border-line rounded-lg text-sm bg-bg">
              ...
              <div>
                ...
                <select value={dest} onChange={e => setDest(e.target.value)} className="w-full px-3 py-2 border border-line rounded-lg text-sm bg-bg">
            ...
            <div className="space-y-3">
              ...
              <input type="range" value={goodsValue} onChange={e => setGoodsValue(Number(e.target.value))} className="w-full h-1.5 bg-surface-2 rounded-lg appearance-none cursor-pointer accent-accent" min="0" max="500000" step="100" />
            </div>

            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="text-xs text-ink-soft mb-1 block">Fret (€)</label>
                <input type="number" value={freight} onChange={e => setFreight(Number(e.target.value))} className="w-full px-3 py-2 border border-line rounded-lg text-sm bg-bg" />
              </div>
              <div>
                <label className="text-xs text-ink-soft mb-1 block">Assurance (€)</label>
                <input type="number" value={insurance} onChange={e => setInsurance(Number(e.target.value))} className="w-full px-3 py-2 border border-line rounded-lg text-sm bg-bg" />
              </div>
            </div>

            <button onClick={handleCalculate} disabled={loading} className="w-full bg-accent text-white py-3 rounded-xl font-semibold hover:bg-accent-strong disabled:opacity-50 flex items-center justify-center gap-2 text-sm transition-colors">

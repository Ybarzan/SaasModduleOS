// Port du web (frontend/src/lib/offlineQueue.ts) : IndexedDB fonctionne à
// l'identique dans une webview Capacitor, pas besoin d'un plugin natif.
const DB_NAME = 'incokalk-mobile-offline';
const DB_VERSION = 1;
